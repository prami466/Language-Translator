...
history=simple_rnn_model.fit(tmp_x, preproc_french_sentences, batch_size=1024, epochs=1, validation_split=0.2)
...
import pickle
pickle.dump(simple_rnn_model, open('simple_rnn_model.pkl','wb'))
pickle.dump(english_tokenizer, open('english_tokenizer.pkl','wb'))
pickle.dump(french_tokenizer, open('french_tokenizer.pkl','wb'))